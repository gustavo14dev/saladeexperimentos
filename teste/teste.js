...
let correcoesData = [];
let bancoImagens = {};
// Inicializada como objeto vazio para ser carregada via fetch.
...
function toggleToolsMenu() {
    // Função mantida para compatibilidade, mas a UI não usa mais dropdown no novo design
    // Se precisar reativar para telas minúsculas:
...
const paragrafos = texto.trim().split(/\n{2,}/);
    ...
    let textoFormatado = paragrafos.map(paragrafo => {
        ...
        // não envolver em <p> para 
evitar margens desnecessárias.
...
div.id = 'digitando';
            ...
            // Avatar para o digitando também
            div.innerHTML = `
                <div class="avatar-bot">
                    <span class="material-symbols-rounded">smart_toy</span>
                </div>
                <div class="message-content">Dora AI está pensando...</div>`;
...
chatBox.innerHTML = `
        <div class="mensagem bot boas-vindas-inicial">
            ...
            <div class="message-content">
                <h2>Olá! Sou a Dora AI.</h2>
                <p>Sou seu assistente pessoal inteligente. Estou pronta para ajudar você a criar, corrigir e imaginar.</p>
                <div class="feature-grid">
                    <div class="feature-item"><span class="material-symbols-rounded">edit_note</span> Redações</div>
                    <div class="feature-item"><span class="material-symbols-rounded">image</span> Imagens</div>
                    <div class="feature-item"><span class="material-symbols-rounded">spellcheck</span> Correção</div>
                    <div class="feature-item"><span class="material-symbols-rounded">summarize</span> Resumos</div>
                </div>
            </div>
        </div>
    `;
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    fetch('training.json').then(r => r.json()).then(d => 
treinamentos = d).catch(e => console.log(e));
