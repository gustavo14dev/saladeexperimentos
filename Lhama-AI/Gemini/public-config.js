// WARNING: This file exposes API keys in the frontend. Only use if you understand the risks.
// Add your keys here. These will be available as window.GEMINI_API_KEY etc.
